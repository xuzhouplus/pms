 ...
 * @package app\models
 */
class SiteSetting extends SettingModel
{
	//维护状态
	...
	{
		return [
			self::SETTING_KEY_TITLE,
			self::SETTING_KEY_ICP,
			self::SETTING_KEY_VERSION,
			self::SETTING_KEY_MAINTAIN,
			self::SETTING_KEY_ICON,
			self::SETTING_KEY_LOGO,
			self::SETTING_KEY_ENCRYPT_SECRET,
			self::SETTING_KEY_LOGIN_DURATION
		];
	}
}